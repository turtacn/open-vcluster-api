...
class SnapshotStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    SNAPSHOT_STATUS_UNKNOWN: _ClassVar[SnapshotStatus]
...
class WatchEventType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    WATCH_EVENT_TYPE_UNKNOWN: _ClassVar[WatchEventType]
...
PHASE_PENDING: Phase
SNAPSHOT_STATUS_UNKNOWN: SnapshotStatus
...
WATCH_EVENT_TYPE_UNKNOWN: WatchEventType
